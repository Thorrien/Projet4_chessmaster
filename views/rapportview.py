...
class RapportView:
    ...
    def printMatchListTournament(self, tables, tournament):
        print('\n\n-----------------------------------------------------')
        print("      Liste des matchs par tours du tournoi ",
              f"{tournament.name}\n")
        for table in tables:
            print("\n\n")
            print(tabulate(table, headers="firstrow"))
    ...
    def printActualRound(self, table, tournament):
        print('\n\n-----------------------------------------------------')
        print("              ",
              f"{tournament.roundList[len(tournament.roundList)-1].name} ",
              f"du tournoi : {tournament.name} \n")
        print("               Liste des matchs du tour\n")
        print("\n")
        print(tabulate(table, headers="firstrow"))

    def printPlayerScores(self, table, tournament):
        print("  Liste des scores du tour pour le tournoi : ",
              f"{tournament.name} \n")
        print(tabulate(table, headers="firstrow"))
        input("\nAppuyez sur Entrée pour continuer...")
